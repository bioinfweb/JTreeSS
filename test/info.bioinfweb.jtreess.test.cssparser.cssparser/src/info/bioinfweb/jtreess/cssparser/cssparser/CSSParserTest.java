package info.bioinfweb.jtreess.cssparser.cssparser;
    ...
    public static void main(String[] args) {
     ...
     public boolean parse(String cssfile) {
         ...
         try
         {
                ...
                InputStream stream = new FileInputStream(new File(cssfile)); //oParser.getClass().getResourceAsStream(cssfile);
